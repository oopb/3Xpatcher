...
echo "3Xpatcher V18 hotfix overlay applied."
echo "Backup: $backup"
echo "UI: native /panel/inbounds + full native client action, QR, raw and Clash subscription parity"
echo "Security: supplemental self-signed TLS is persisted as native 3x-ui certificateFile/keyFile paths before save validation"
...
echo "Compatibility: supplemental inbounds use native-style transport/security badges without protocol-version badges"
