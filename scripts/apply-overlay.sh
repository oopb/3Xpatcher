...
echo "3Xpatcher V19 hotfix overlay applied."
echo "Backup: $backup"
echo "UI: native /panel/inbounds + full native client action, QR, raw and Clash subscription parity"
echo "Security: generated self-signed TLS is stored as native 3x-ui certificateFile/keyFile paths before save validation"
