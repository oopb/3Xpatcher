...
echo "3Xpatcher V11.4 integrated overlay applied."
echo "Backup: $backup"
...
echo "Compatibility: Shadowrocket ShadowTLS uses the descriptor form, Naive uses S-UI http2 links, and TUIC Clash keeps the pre-Mieru known-good shape with h3"
