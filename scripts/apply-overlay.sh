...
echo "3Xpatcher V11.6 integrated overlay applied."
echo "Backup: $backup"
...
echo "Compatibility: Shadowrocket ShadowTLS descriptor + S-UI Naive http2; TUIC Clash matches known-good Mihomo native UDP relay and preserves ordered ALPN"
